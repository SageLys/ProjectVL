...
const COMMON_FIELD_LABELS: Record<string, string> = {
  ...
  base: '基准值', batchMax: '单批上限', boss: 'Boss', bossReward: 'Boss 奖励', build: '构筑',
  ...
  effects: '效果', enabled: '启用', end: '终点值', enemy: '敌人', epic: '史诗', equip: '装备态',
  ...
  label: '显示名', labelKey: '文案键', life: '存活时间', mainRosterSize: '主池规模',
  max: '最大值', maxAlive: '同时存活上限', maxStacks: '最大层数', min: '最小值',
  minStar: '最低星级', mul: '乘数', multiplier: '倍率', name: '名称', options: '选项',
  outputCardId: '产出卡', outputStar: '产出星级', params: '参数', path: '配置路径',
  perWave: '每波增量', pityDrops: '保底掉落次数', pivot: '拐点', poolInfluence: '池影响',
  power: '曲线指数', r: '半径', radius: '半径', range: '射程', rare: '稀有', rarity: '稀有度',
  ratio: '比例', relaxed: '轻松', reward: '奖励', scale: '缩放', selection: '抽取',
  ...
  targetTags: '目标标签', teaching: '教学卡', textKey: '文案键', tier: '形态', trigger: '触发器',
