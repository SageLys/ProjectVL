...
export function renderRelicView(container: HTMLElement, relic: RelicDef, ctx: DescribeContext, relicIndex?: number): void {
  ...
  article.append(heading, badges, el('p', view.desc ? 'overview' : 'overview missing-copy', view.desc || '缺失：desc'));
