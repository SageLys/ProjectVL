...
export function getDomRefs() {
  return {
    ...
    rewardPointsText: el<HTMLElement>('#rewardPointsText'),
    rewardThresholdText: el<HTMLElement>('#rewardThresholdText'),
    rewardBar: el<HTMLElement>('#rewardBar'),
    waveText: el<HTMLElement>('#waveText'),
    evolutionHudText: el<HTMLElement>('#evolutionHudText'),
    ...
    validationSettleBtn: el<HTMLButtonElement>('#validationSettleBtn'),
