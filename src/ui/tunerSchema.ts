...
export const DROP_DIRECTOR_TUNER_PARAMS: TunerParam[] = [
  ...
  { path: 'economy.normalDropTypePolicy.godAffinity.scorePerStack', label: '掉落导演 · 每层神倾向分', group: 'drops' },
  { path: 'economy.normalDropTypePolicy.godAffinity.scoreCap', label: '掉落导演 · 神倾向分封顶', group: 'drops' },
...
export const TUNER_PARAMS: TunerParam[] = [
  ...
  { path: 'waves.intermission.settleSeconds', label: '波间结算展示', group: 'waves', waveDeferred: true },
  { path: 'waves.intermission.freeSeconds.selection', label: '波间整备 · 招募', group: 'waves', waveDeferred: true },
  { path: 'waves.intermission.freeSeconds.buildEarly', label: '波间整备 · 收敛前期', group: 'waves', waveDeferred: true },
  { path: 'waves.intermission.freeSeconds.buildLate', label: '波间整备 · 收敛后期', group: 'waves', waveDeferred: true },
  { path: 'waves.intermission.freeSeconds.validation', label: '波间整备 · 兑现', group: 'waves', waveDeferred: true },
  ...
  { path: 'progression.relicChoices', label: '遗物 · 候选数量', group: 'progression' },
